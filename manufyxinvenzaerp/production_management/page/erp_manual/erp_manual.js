...
const ERP_MANUAL_REPORTS_CHILDREN = [
	...
	},
	{
		...
		fields: [
			...
			{ name: "Weight and quantity columns", note: "Customer Weight (Kg), Planned Weight (Kg), Planned Sec Nos, Transferred Weight (Kg), Transferred Sec Nos — the planned-versus-actual comparison, in both weight and pieces. All four weights are for the whole drawing row, so Planned should sit a few percent above Customer; anything near a whole multiple of the quantity means something is being compared per piece against per row." },
